...
export default function LocalPage({ params }) {
    ...
    return (
        <section className='w-full items-center text-center' style={{textAlign:'-webkit-center'}} >
            <div className="p-6 bg-white mb-64 max-w-3xl items-center text-center self-center">
                ...
                <div className="w-full md:w-1/2">
                    ...
                    <img src={fotoLocal} alt={local} className="rounded-xl shadow-lg object-cover" style={{ maxHeight: "350px", width: "100%" }} onLoad={handleImageLoad} loading="lazy"/>
                    </div>
                </div>
