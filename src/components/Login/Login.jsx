...
// Lazy load ToastContainer to reduce initial load
            ...
            <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                <Link href="/" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 justify-center">
                    <img className="mr-2" src='assets/logo/administracion.webp' width={150} height={50} alt="Central cam logo" loading='lazy' />
                </Link>
