...
const TablaSorteosCHW = () => {
  ...
  useEffect(() => {
    ...
    if (selectedEmails.length === userSorteoCHW.length) {
      setSelectAll(true);
    } else {
      setSelectAll(false);
    }
  }, [selectedEmails, userSorteoCHW]);
  ...
  const handleSelectAll = () => {
    if (selectAll) {
      ...
      setSelectedEmails(userSorteoCHW.map(item => item.email));
    }
          ...
          <div className="relative p-4 w-full max-w-2xl max-h-full">
            <div className="relative bg-white rounded-lg shadow">
              ...
              <div className="p-4 md:p-5 space-y-4">
                ...
                <div>
                  <label className="block text-left text-sm font-medium text-gray-700">Mensaje</label>
