      ...
      >
        ...
        <div className="py-4 overflow-y-auto">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-primary-hover group" onClick={() => {handleSelectSection("Sorteo"); toggleMenu()}}>
                ...
                <span className="ml-3 text-gray-200 ">Sorteo</span>
              </Link>
            </li>
